Pod::Spec.new do |s|
  ...
  s.homepage              = 'https://github.com/Staricase/PhoneCountryCodePicker'
  s.ios.deployment_target = '7.0'
  s.license               = { :type => 'MIT', :file => 'LICENSE' }
  s.author                = { 'Dwarven' => 'prison.yang@gmail.com' }
  s.social_media_url      = "https://twitter.com/DwarvenYang"
  s.source                = { :git => 'https://github.com/Staricase/PhoneCountryCodePicker.git', :tag => s.version, :submodules => true }
