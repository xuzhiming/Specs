...
DESC
s.homepage         = "code.tiejin.cn/closer/umscoresdk"
# s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
s.license          = 'MIT'
s.author           = { "xzming" => "xzm@umshz.com" }
s.source           = { :git => "git@code.tiejin.cn:closer/umscoresdk.git", :tag => s.version.to_s }

s.platform     = :ios, '8.0'
s.requires_arc = true

s.source_files = 'Product/**/*.{h,m,mm}'
...
s.dependency 'JSONKit-NoWarning-ext'
...
s.dependency 'ASIHTTPRequest-Rev', '~> 2.0.0'
